...
class InsightsView(ctk.CTkFrame):
    ...
    def __init__(self, master: ctk.CTk, app: Any, **kwargs) -> None:
        ...
        self.app = app
        self._is_destroyed = False  # Track destruction
    ...
    def _call_ai_and_update(self, user_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if not self._is_destroyed:
                ...
                self.after(0, lambda: self._show_message("Insights generated successfully!"))
        except Exception as e:
            if not self._is_destroyed:
                self.after(0, lambda: self._show_message(f"Error: {e}", is_error=True))
